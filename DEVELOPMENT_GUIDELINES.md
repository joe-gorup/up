...
All frontend and backend development is done through Replit Agent. This includes schema changes, API endpoints, storage methods, UI components, pages, and styles.
